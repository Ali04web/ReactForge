...
const HOOKS = [
  { name: "useState", color: "#ef4444", desc: "Local state management." },
  { name: "useEffect", color: "#f97316", desc: "Side effects and lifecycle." },
  { name: "useContext", color: "#ef4444", desc: "Shared values in a tree." },
  ...
  { name: "useReducer", color: "#eab308", desc: "Complex state transitions." },
...
function ChallengeCard({ challenge, index, onLaunch }) {
  ...
  const colors = ["#f97316", "#eab308", "#00d4ff", "#ffee00", "#ff3d00", "#7dff00"];
  ...
  return (
    <button
      ...
      style={{
        ...
        background: hovered ? `linear-gradient(135deg, ${color}1a, #1c1917)` : "#1c1917",
      }}
      ...
      <main className="home-main">
            ...
            <h1 className="hero-title">
              ...
              <span
                style={{
                  ...
                  filter: "drop-shadow(0 0 20px #f9731688)",
                }}
              >
                Practice.
              </span>
        ...
        <div
          style={{
            height: "1px",
            background:
              "linear-gradient(90deg, transparent, rgba(249, 115, 22,0.5), rgba(234, 179, 8,0.3), transparent)",
                ...
                {["All", "Easy", "Medium", "Hard"].map((level) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        color: selected ? "#0c0a09" : "rgba(255,255,255,0.45)",
                        background: selected ? "#f97316" : "transparent",
                        fontWeight: selected ? 700 : 400,
                        boxShadow: selected ? "0 0 14px #f9731677" : "none",
                      }}
                    >
                      {level}
                    </button>
